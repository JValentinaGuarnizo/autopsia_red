...
export default function RedInteractivaMejorada() {
    ...
    const sumaSinSesgo = [0, 0, 0, 0];
    const sumaConSesgo = [0.23089342, -0.07109793, 0.0470638, 0.62113106];
    const activacion = [0.23089342, 0, 0.0470638, 0.62113106];
